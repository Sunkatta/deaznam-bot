...
# TODO: Extract in different file/module/package
...
class Music(commands.Cog):
    ...
    @commands.command()
    async def ddzjoin(self, ctx, *, channel: discord.VoiceChannel):
    ...
    @commands.command()
    async def ddzvolume(self, ctx, volume: int):
