...
# Installation
1. To install the required dependencies, please go to `cd src` and run `pip install -r requirements.txt`.
    - Alternatively, if you want to upgrade your already installed packages, run `pip install --upgrade -r requirements.txt`.
